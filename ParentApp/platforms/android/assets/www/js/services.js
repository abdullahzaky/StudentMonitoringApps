...
.factory('LoginService', function ($http, user, $location, $window) {
...
.factory('MahasiswaService', function ($http) {
    ...
    return {
        ...
        //getLinePeriod: function (id) {
        //    return $http.get("http://localhost:8008/api/mahasiswa/summary/" + id).then(function (response) {
        //        var value_ips = [];
        //        var value_sks = [];
        //        var periode = [];
        //        var data = response.data.EnrollIps
        //        for (var key in data) {
        //            value_ips.push(data[key].Ips);
        //            value_sks.push(data[key].Sks);
        //            periode.push(data[key].PeriodeEnroll);
        //        }
        //        return { nama: periode, ips: value_ips, sks: value_sks }
        //    }, function (failure) {
        //        console.log("Failed to get period summary mahasiswa :service" + failure.statusText);
        //        return failure;
        //    });
        //},
...
.factory('NilaiService', function ($http) {
    return {
